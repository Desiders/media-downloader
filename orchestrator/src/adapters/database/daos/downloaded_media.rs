use sea_orm::{ActiveValue::Set, ColumnTrait, ConnectionTrait, EntityTrait as _, QueryFilter as _, prelude::Expr, sea_query::OnConflict};
use std::convert::Infallible;

use crate::{
    adapters::database::models::{downloaded_media, sea_orm_active_enums},
